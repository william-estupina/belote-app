...
/** Stride par carte dans le buffer worklet : 14 valeurs */
export const STRIDE_UNIFIE = 14;

/** Nombre total de slots : 8 sud + 24 adversaires */
...
/**
 * Canvas Skia unifié permanent qui dessine les 32 slots de cartes (8 sud + 24 adversaires).
 * Toujours monté, les cartes inactives sont parquées off-screen.
 * Un seul draw call GPU.
 */
export function CanvasCartesUnifie({
  ...
  // Pivot centre uniforme pour toutes les cartes
