...
export const CanvasAdversaires = memo(
  ...
  (prev, next) => {
    // Pendant la distribution, l'animation est pilotée par les SharedValues.
    // Ignorer les changements de nbCartesAdversaires et cartesAtlasAdversaires
    // pour éviter de re-renderiser le canvas Skia inutilement.
    if (next.distributionEnCours && prev.distributionEnCours) {
      return (
